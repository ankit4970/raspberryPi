 ...
 * @param[in]	i2cDevice	: I2C bus dev entry ("/dev/i2c/0" or "/dev/i2c/1" entry)
 ...
 * @param[in]	i2cDevice	: I2C bus dev entry ("/dev/i2c/0" or "/dev/i2c/1" entry)
 * 				devAddress  : I2C slave address
 * @return 		File descriptori2cset -y 0 0x50 0x00 0x10
***************************************************************************************************/
int i2CSetupDevice(const char *devBus, int devAddress)
{
	int fd = 0;
